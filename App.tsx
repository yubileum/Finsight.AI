      ...
      <nav className="bg-white/90 backdrop-blur-xl border-b border-slate-200/50 sticky top-0 z-50 shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 flex justify-between h-16 sm:h-20 items-center">
          ...
          <div className="flex items-center space-x-2 sm:space-x-4">
            ...
            <button onClick={() => setShowApiKeyModal(!showApiKeyModal)} className="p-2 sm:p-2.5 rounded-xl sm:rounded-2xl text-slate-500 hover:bg-slate-50 transition-colors" title="Google connection">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-10 py-8 sm:py-12 lg:py-16">
        ...
        {isAnalyzing && (
          <div className="flex flex-col items-center justify-center py-20 sm:py-32 lg:py-40 bg-white rounded-[2rem] sm:rounded-[3rem] lg:rounded-[4rem] border border-slate-100 shadow-lg relative overflow-hidden">
            ...
            <p className="text-slate-500 font-bold uppercase tracking-[0.15em] sm:tracking-[0.2em] text-[10px] sm:text-xs bg-slate-100 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full mb-8 sm:mb-10">{loadingProgress}</p>
            ...
            <div className="w-full max-w-md px-4">
              <div className="relative">
                ...
                <div className="h-3 sm:h-4 bg-slate-100 rounded-full overflow-hidden shadow-inner">
                  ...
                  <div
                    className="h-full bg-gradient-to-r from-indigo-500 via-indigo-600 to-indigo-700 rounded-full transition-all duration-500 ease-out relative overflow-hidden"
                    style={{
                      width: `${Math.min(
                        100,
